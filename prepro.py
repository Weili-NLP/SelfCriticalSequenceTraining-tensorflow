...
def main():
    ...
    # vgg model path
    vgg_model_path = '/ais/gobi4/linghuan/attention_img_cap/data/imagenet-vgg-verydeep-19.mat'

    # about 80000 images and 400000 captions for train dataset
    train_dataset = _process_caption_data(
        caption_file='/ais/gobi4/linghuan/mscoco/mscoco/annotations/captions_train2014.json',
        image_dir='/ais/gobi4/linghuan/mscoco/train2014_resized',
        max_length=max_length)

    # about 40000 images and 200000 captions
    val_dataset = _process_caption_data(
        caption_file='/ais/gobi4/linghuan/mscoco/mscoco/annotations/captions_val2014.json',
        image_dir='/ais/gobi4/linghuan/mscoco/val2014_resized',
        max_length=max_length)
